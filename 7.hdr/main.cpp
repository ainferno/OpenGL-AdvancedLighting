...
// --- HDR FBO globals ---
unsigned int hdrFBO = 0, colorBuffer = 0, rboDepth = 0;
...
int main() {
    GLFWwindow* window = init_gl_window("HDR");
    if (!window) { return -1; }

    Shader shader("7.hdr/lighting.vs", "7.hdr/lighting.fs");
    Shader hdrShader("7.hdr/hdr.vs", "7.hdr/hdr.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Tunnel (scaled cube, rendered from inside)
