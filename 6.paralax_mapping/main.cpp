...
int main() {
    ...
    Shader shader("6.paralax_mapping/normal_mapping.vs", "6.paralax_mapping/normal_mapping.fs");
    Shader shaderLightCube("6.paralax_mapping/light_cube.vs", "6.paralax_mapping/light_cube.fs");
    ...
    unsigned int displMap  = loadTexture("../resources/textures/bricks2_disp.jpg");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glBindTexture(GL_TEXTURE_2D, displMap);
